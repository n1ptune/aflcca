...
target_ulong HELPER(AflEnv)(CPUARMState *env, target_ulong code, target_ulong a1, target_ulong a2)
{
    // TCGv_i64 val = tcg_constant_i64(42);
    // uint64_t tmp = env->xregs[0];
    // uint64_t tmp1 = env->regs[0];
    // env->xregs[0] = 0;
    // env->regs[0] = 0;
