...
static bool trans_AflEnv(DisasContext *s, arg_AflEnv *a)
{
    TCGv_i64 tmp1 = cpu_reg(s, 0);
    TCGv_i64 tmp2 = cpu_reg(s, 1);
    TCGv_i64 tmp3 = cpu_reg(s, 2);
    gen_helper_AflEnv(tmp1, tcg_env, tmp1, tmp2, tmp3);
    //printf("afl insn %x \n", cpu_X[0]);
    return true;
}
